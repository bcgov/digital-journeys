...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    ...
    <#elseif section = "form">
    <div id="kc-form" class="bhumin">
      <header id="panel-heading-header-placement" class="${properties.kcFormHeaderClass!} panel-heading">&nbsp;</header>
            ...
            <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                ...
                <div class="${properties.kcFormGroupClass!} ${properties.kcFormSettingClass!}">
                  ...
                  <div id="kc-form-buttons" class="${properties.kcFormGroupClass!}">
                      ...
                      <input tabindex="4" class="sign-in-cls ${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!}" name="login" id="kc-login" type="submit" value="${msg("doLogIn")}"/>
                  </div>
            </form>
        </#if>
        </div>
