...
export const COMPLAINT_INTAKE_FORM_1_10_NOEMAIL =
  "1.10_COMPLAINT_INTAKE_FORM_NOEMAIL";
export const INFLUENZA_WORKSITE_REGISTRATION =
  "INFLUENZA_WORKSITE_REGISTRATION";
export const INFLUENZA_WORKSITE_REGISTRATION_EDIT =
  "INFLUENZA_WORKSITE_REGISTRATION_EDIT";
export const MATERNITY_AND_PARENTAL_LEAVE_FORM =
  "MATERNITY_AND_PARENTAL_LEAVE_FORM";
export const MATERNITY_AND_PARENTAL_LEAVE_FORM_INELIGIBLE =
  "MATERNITY_AND_PARENTAL_LEAVE_FORM_INELIGIBLE";
export const MATERNITY_AND_PARENTAL_LEAVE_FORM_APPROVED =
  "MATERNITY_AND_PARENTAL_LEAVE_FORM_APPROVED";
export const MATERNITY_AND_PARENTAL_LEAVE_FORM_DENIED =
  "MATERNITY_AND_PARENTAL_LEAVE_FORM_DENIED";
...
export const COI_SUPERVISOR_SUBMISSION_APPROVED =
  "COI_SUPERVISOR_SUBMISSION_APPROVED";
export const COI_SUPERVISOR_SUBMISSION_LDB_APPROVED =
  "COI_SUPERVISOR_SUBMISSION_LDB_APPROVED";
...
const submitSuccessPage = {
  ...
  "bullying-and-harassment-complaint-article-1-10-ldb":
    COMPLAINT_INTAKE_FORM_1_10_LDB,
  "bullying-and-harassment-complaint-article-1-10-noemail":
  ...
  "maternity-parental-leave-and-allowance-ineligible":
    MATERNITY_AND_PARENTAL_LEAVE_FORM_INELIGIBLE,
  ...
  if (formKey === "bullying-and-harassment-complaint-article-1-10") {
    if (
      submission?.data?.pleaseSelectTheUnionYouBelongTo ===
        "bcGeneralEmployeesUnionBcgeu" &&
      submission?.data?.areYouAnEmployeeOfTheLiquorDistributionBoardLdb ===
        "yes"
    ) {
      if (
        submission?.data?.yourPreferredEmailAddress.includes("gov.bc.ca") ||
