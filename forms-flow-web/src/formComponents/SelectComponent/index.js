...
/**
 * Overrides the default Select component
 *
 * Select will support tooltip that is displayed as a popup
 * 
 */
export default class DGJSelectComponent extends SelectComponent {
  attach(element) {
    const webForm = this;
