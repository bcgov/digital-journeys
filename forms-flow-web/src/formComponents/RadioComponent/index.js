...
/**
 * Overrides the default Radio component
 *
 * Radio will support tooltip that is displayed as a popup
 * 
 */
export default class DGJRadioComponent extends RadioComponent {
  attach(element) {
    const webForm = this;
