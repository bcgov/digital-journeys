...
import {
  ...
  DRAFT_POLLING_RATE,
  STAFF_DESIGNER,
  CLIENT // PB Added CLIENT role to allow access to the form
...
const View = React.memo((props) => {
  ...
  */
  ...
  useEffect(() => {
    if (user && user.role.some((el) => el === STAFF_DESIGNER || el === CLIENT)) { // PB Added CLIENT role to allow access to the form
