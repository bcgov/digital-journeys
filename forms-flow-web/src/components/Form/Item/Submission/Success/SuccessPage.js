...
export default React.memo(() => {
  ...
  const getBody = () => {
    if (search.includes(successTypes.TELEWORK_SUBMISSION)) {
          ...
          <div className="success-content-body">
            <ul>
              <li>
                ...
                the employee&apos;s personnel file. You will receive a
                confirmation from AskMyHR that the service request has been
                created
              </li>
            </ul>
          </div>
      ...
      search.includes(successTypes.COI_SUPERVISOR_SUBMISSION_LDB_APPROVED)
    ) {
      return (
        <>
          <span className="success-content-intro">
          ...
          <div className="success-content-body">
            <ul>
              <li>
                The form will be automatically sent to LDB Ethics Advisor for
                inclusion on the employee&apos;s personnel file
              </li>
            </ul>
          </div>
        </>
