...
export const sortingList = [
  ...
  {
    sortBy: "priority",
    label: <Translation>{(t) => t("Priority")}</Translation>,
    sortOrder: "asc",
  },
  {
    sortBy: "dueDate",
  ...
  {
    sortBy: "name",
    label: <Translation>{(t) => t("Task name")}</Translation>,
    sortOrder: "asc",
  },
  {
    sortBy: "followUpDate",
    label: <Translation>{(t) => t("Follow up Date")}</Translation>,
    sortOrder: "asc",
  },
];
...
export const searchData = [
  {
    label: <Translation>{(t) => t("Task Variables")}</Translation>,
    compares: [">", ">=", "=", "!=", "<", "<="],
  },
  {
    label: <Translation>{(t) => t("Process Variables")}</Translation>,
    compares: [">", ">=", "=", "!=", "<", "<="],
  },
  {
  ...
  {
    label: <Translation>{(t) => t("Candidate User")}</Translation>,
    compares: ["="],
    values: ["candidateUser"],
  },
  {
    label: <Translation>{(t) => t("Name")}</Translation>,
    compares: ["like", "="],
...
export const taskFilters = [
  {
    ...
    operator: FILTER_OPERATOR_TYPES.EQUAL,
    type: Filter_Search_Types.VARIABLES,
    value: "",
    name: "",
  },
  {
  ...
  // },
  {
    ...
    key: "candidateGroup",
    operator: FILTER_OPERATOR_TYPES.EQUAL,
    type: Filter_Search_Types.NORMAL,
    value: "",
  },
  {
    label: <Translation>{(t) => t("Candidate User")}</Translation>,
...
export const QUERY_TYPES = {
  ANY: <Translation>{(t) => t("ANY")}</Translation>,
